            ...
            {[
              {
                ...
                kicker: '系统 / SYSTEM',
                title: '解释的依据是什么？',
                body: 'AI 到底是靠什么拍板的？我们要摸清它肚子里有哪些数据和规则，确保它的解释不是在“胡说八道”，而是真正反映了它的思考过程。',
              ...
              },
              {
                ...
                kicker: '人 / HUMAN',
                title: '谁需要理解什么？',
                body: '程序员想用它找 Bug，普通用户想看它靠不靠谱。面对同一个 AI，不同的人想听到的“大白话”是完全不一样的。',
              ...
              },
              {
                ...
                kicker: '情境 / CONTEXT',
                title: '理解之后，能做什么？',
                body: '听懂了解释，然后呢？是为了让人能在 AI 犯傻时去纠正它，或者在关键时刻踩刹车。解释好不好用，最终得看人机配合能不能把事办成。',
